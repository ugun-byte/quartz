...
- **데스크톱에서는 왼쪽 사이드바**에서 인물 이름을 한글·영문으로 바로 클릭해 들어갈 수 있습니다.
- 모바일에서는 **위 카드**와 [[atlas/people|인물 아틀라스]]를 중심으로 더 편하게 탐색할 수 있습니다.
- 4시간 브리핑을 하루 단위로 다시 보려면 [[daily/index|일간 신호 자료실]]을 확인하면 됩니다.
